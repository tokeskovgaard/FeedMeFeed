...
*/
    ...
    private Widget createQuestionWidget(FeedItemGWT feedItemGWT, QuestionGWT question) {
        ...
        switch (question.getType()) {
            case bool:
                typeWidget = createBoolQuestionWidget(questionItem);
                break;
            case numeric:
    ...
    private Widget createBoolQuestionWidget(QuestionItemGWT questionItem) {
        CheckBox checkBox = new CheckBox();
        checkBox.setValue(Boolean.TRUE.equals(questionItem.getBoolAnswer()));
        return checkBox;
    }
